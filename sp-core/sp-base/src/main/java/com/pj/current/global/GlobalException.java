...
//    	System.out.println("全局异常");
		...
		// 普通异常输出：500 + 异常信息 
			...
			if(e instanceof SQLException || e2 instanceof SQLException) {
				if(SpCfgUtil.get_throw_out_sql() == false) {
			...
			// 如果是sentinel流量异常 		(FlowException)
			else if(e instanceof BlockException || e2 instanceof BlockException) {
				aj = AjaxJson.get(503, "系统繁忙，请稍后重试"); 
			} 
			// 什么都不是，那么取异常信息 
			else {
